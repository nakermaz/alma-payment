...
## Готовые запросы (Insomnia)

В корне проекта находится файл `Insomnia_2026-04-02.yaml` с готовой коллекцией запросов для [Insomnia](https://insomnia.rest/). Чтобы использовать:

1. Откройте Insomnia
2. Перейдите в **Application → Import** (или `Ctrl+O`)
3. Выберите файл `Insomnia_2026-04-02.yaml`

После импорта будут доступны все запросы к API сервиса.
